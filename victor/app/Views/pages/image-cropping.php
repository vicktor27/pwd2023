...
<div id="image-cropping">
    ...
    <div id="jcrop-demo-tab" role="tabpanel">
        ...
        <div class="tab-content bg-white padding-15">
            <div role="tabpanel" class="tab-pane active styling clearfix">
                ...
                <div class="pull-left">
                    <img src="<?= base_url() ?>assets/img/demo/1_680.jpg" class="styling-img" alt="[Jcrop Example]"/>
                </div>
            ...
            <div role="tabpanel" class="tab-pane basic-setup">
                ...
                <img src="<?= base_url() ?>assets/img/demo/2_680.jpg" alt="[Jcrop Example]"/>
            </div>
            <div role="tabpanel" class="tab-pane basic-handler clearfix">
                ...
                <div class="pull-left">
                    <img src="<?= base_url() ?>assets/img/demo/3_680.jpg" alt="[Jcrop Example]"/>
                </div>
                <form class="coords">
            ...
            <div role="tabpanel" class="tab-pane aspect-ratio clearfix">
                ...
                <div class="pull-left">
                    <img src="<?= base_url() ?>assets/img/demo/4_680.jpg" class="aspect-ratio-img" alt="[Jcrop Example]"/>
                </div>
                <div id="preview-pane">
                    <div class="preview-container">
                        <img src="<?= base_url() ?>assets/img/demo/4_680.jpg" class="jcrop-preview" alt="Preview" />
                    </div>
                </div>
            </div>
            <div role="tabpanel" class="tab-pane animation-transitions clearfix">
                ...
                <div class="pull-left">
                    <img src="<?= base_url() ?>assets/img/demo/5_680.jpg" class="animation-transitions-img" alt="Preview" />
                </div>
                <div class="pull-left padding-15">
                    <div id="interface">
            ...
            <div role="tabpanel" class="tab-pane api-demo clearfix">
                <div class="pull-left">
                    <img src="<?= base_url() ?>assets/img/demo/8_680.jpg" class="api-img" alt="Preview" />
                </div>
                <div class="pull-left padding-15">
                    <div>
    ...
    <script type="text/javascript">
        LobiAdmin.loadScript([
            'assets/js/plugin/jcrop/jquery.Jcrop.min.js',
            'assets/js/plugin/jcrop/jquery.color.js'
        ], initPage);
...
//                            $(e.target).closest('.btn-group').find('.active').removeClass('active');
            ...
            (function(){
                ...
                $('#img1').click(function (e) {
                    ...
                    jcrop_api.setImage('<?= base_url() ?>assets/img/demo/8_680.jpg', function(){
                        this.setOptions({
                            bgOpacity: 0.5,
                            outerImage: '<?= base_url() ?>assets/img/demo/8_680.jpg'
                        });
                ...
                $('#img2').click(function (e) {
                    ...
                    jcrop_api.setImage('<?= base_url() ?>assets/img/demo/9_680.jpg', function(){
                        this.setOptions({
                            bgOpacity: 0.5,
                            outerImage: '<?= base_url() ?>assets/img/demo/9_680.jpg'
                        });
                        this.animateTo(getRandom());
                    });
                    jcrop_api.setOptions({bgOpacity: .6});
                ...
                $('#img3').click(function (e) {
                    ...
                    jcrop_api.setImage('<?= base_url() ?>assets/img/demo/10_680.jpg', function () {
                        this.setOptions({
                            bgOpacity: 0.5,
                            outerImage: '<?= base_url() ?>assets/img/demo/10_680.jpg'
                        });
                        this.animateTo(getRandom());
                    });
                    return false;

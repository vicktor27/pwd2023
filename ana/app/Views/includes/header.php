...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/'); ?>css/lobiadmin-with-plugins.css" />
    <!--Put your css here-->
...
<body>
    <nav class="navbar navbar-default navbar-header header">
        <a class="navbar-brand" href="#">
            ...
            <!--<img src="<?= base_url('assets/'); ?>img/logo/lobiadmin-logo-text-white-32.png" class="hidden-xs" alt="" />-->
        </a>
            ...
            <ul class="nav navbar-nav navbar-right user-actions">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img class="user-avatar" src="<?= base_url('assets/'); ?>img/users/me-160.jpg" alt="..." />
                        <b class="caret"></b>
                    </a>
                    <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?= base_url('users/autoLogout'); ?>"><span class="glyphicon glyphicon-lock"></span> &nbsp;&nbsp;Lock screen</a></li>
                        <li><a href="<?= base_url('users/logout'); ?>"><span class="glyphicon glyphicon-off"></span> &nbsp;&nbsp;Log out</a></li>
                    </ul>
                </li>
            </ul>
        </div>
        ...
        <div class="navbar-items-2">
            ...
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?= base_url('assets/'); ?>img/flags/en.png" alt="en" />
                    ...
                    <ul class="dropdown-menu">
                        <li class="active">
                            <a href="#">
                                <img src="<?= base_url('assets/'); ?>img/flags/en.png" alt="en" /> english(UK)
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="<?= base_url('assets/'); ?>img/flags/us.png" alt="en" /> english(US)
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="<?= base_url('assets/'); ?>img/flags/fr.png" alt="en" /> français
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="<?= base_url('assets/'); ?>img/flags/it.png" alt="en" /> italiano
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="<?= base_url('assets/'); ?>img/flags/ru.png" alt="en" /> русский
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="<?= base_url('assets/'); ?>img/flags/de.png" alt="en" /> deutsch
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="<?= base_url('assets/'); ?>img/flags/es.png" alt="en" /> español
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="<?= base_url('assets/'); ?>img/flags/ge.png" alt="en" /> ქართული
                            </a>
                        </li>
                        ...
                        <ul class="notifications-body max-h-300">
                            <li class="unread">
                                <a href="#lobimail" data-action="open-email" data-key="1" class="notification">
                                    <img class="notification-image" src="<?= base_url('assets/'); ?>img/users/1.jpg" alt="">
                            ...
                            <li class="unread">
                                <a href="#lobimail" data-action="open-email" data-key="2" class="notification">
                                    <img class="notification-image" src="<?= base_url('assets/'); ?>img/users/2.jpg" alt="">
                                    <div class="notification-msg">
                            ...
                            <li class="unread">
                                <a href="#lobimail" data-action="open-email" data-key="3" class="notification">
                                    <img class="notification-image" src="<?= base_url('assets/'); ?>img/users/3.jpg" alt="">
                                    <div class="notification-msg">
                                        <h4 class="notification-heading">George Darso</h4>
                            ...
                            <li>
                                <a href="#lobimail" data-action="open-email" data-key="4" class="notification">
                                    <img class="notification-image" src="<?= base_url('assets/'); ?>img/users/4.jpg" alt="">
                                    <div class="notification-msg">
                            ...
                            <li>
                                <a href="#lobimail" data-action="open-email" data-key="5" class="notification">
                                    <img class="notification-image" src="<?= base_url('assets/'); ?>img/users/5.jpg" alt="">
                                    <div class="notification-msg">
                        ...
                        <ul class="notifications-body max-h-300">
                            ...
                            <li>
                                <div class="notification">
                                    ...
                                    <a href="#"><img src="<?= base_url('assets/'); ?>img/users/me-160.jpg" alt="" class="liked-photo" /></a>
                                </div>
                            </li>
                            <li>
                                <div class="notification">

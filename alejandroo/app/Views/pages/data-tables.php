...
<div id="data-tables">
    ...
    <div class="panel panel-light">
        ...
        <div class="panel-body">
            <div class="callout callout-info">
                <p>Resize the screen to seen horizontal scroll</p>
            </div>
    ...
    <div class="panel panel-light">
        <div class="panel-heading">
            <div class="panel-title">
                <h4>Column rendering</h4>
            </div>
        </div>
        <div class="panel-body">
            <div class="callout callout-info">
                <p>Table has responsive feature. Resize the screen and have a look</p>
            </div>
    ...
    <div class="panel panel-light">
        <div class="panel-heading">
            <div class="panel-title">
                <h4>Individual column searching</h4>
            </div>
        </div>
        <div class="panel-body">
             <div class="callout callout-info">
            ...
            <table id="data-table-example4" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th class="with-input"><input type="text" class="form-control" placeholder="Age"/></th>
                        <th class="with-input">
                        ...
                        <th class="with-input"><input type="text" class="form-control" placeholder="Salary"/></th>
                    </tr>
                    <tr>
                        <th>Name</th>
                        <th>Position</th>
    ...
    <script type="text/javascript">
        LobiAdmin.loadScript([
            ...
            LobiAdmin.loadScript([
                ...
                'assets/js/plugin/datatables/dataTables.responsive.min.js',
                'assets/js/plugin/bootstrap-datepicker/bootstrap-datepicker.js'
            ], initPage);
        });
